...
const vi: Dict = {
  ...
  "lb.collective": "tổng quãng đường tất cả Amazers đã đi 🎉",
  "lb.steps": "≈ {n} bước chân",
  "lb.journey": "tương đương quãng đường Hà Nội → {place}",
...
const en: Dict = {
  ...
  "lb.collective": "total distance walked by all Amazers 🎉",
  "lb.steps": "≈ {n} steps",
  "lb.journey": "that's Hà Nội → {place}",

...
const vi: Dict = {
  ...
  "confirm.giftAlready": "🎁 Bạn đã nhận quà của mình rồi — nhưng mỗi lượt chạy vẫn được tính vào bảng xếp hạng và giải Top 1. Cứ bứt phá nhé!",
...
const en: Dict = {
  ...
  "confirm.giftAlready": "🎁 You've already claimed your gift — but every run still counts toward the leaderboard and the Top-1 award. Give it your best!",
